        ...
        <div class="container" style="margin-top: 40px;">
            <div class="row m-3 p-4">
              <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                  ...
                  src="
                  https://vnw-img-cdn.popsww.com/api/v2/containers/file2/cms_thumbnails/cgnv_thumb_640x960-efc26c426e5a-1628236333906-FJaLHrt0.jpg?v=0&maxW=420&format=webp                   " alt="">
              </div>
              <div class="col-7">
                  <h1 style="color: #fff; margin-top: 10px;">Bỗng Một Ngày Trở Thành Con Gái Nhà Vua</h1>
                  <div class="flex py-2 px-2.5 no-underline capitalize desktop:min-w-0 mobile:py-0 mobile:px-4 social_item__0U5H7 comics flex items-center mx-2.5 mobile:flex-col null flex-row">
                        ...
                        <span class="social_infoNumber__8SNKv">800K</span>&nbsp;Lượt xem</span>
                        <i class="fa-solid fa-thumbs-up" style="margin-left: 5px;"></i>
                        <span>40K &nbsp;Thích</span> 
                        </div>
                    </div>
                    <button class="read"> ĐỌC NGAY</button>
                    <p>Tác giả: Truyền Kỳ Mạn Nghiệp/p>
                    <p>Họa sĩ: Comic</p>
                    <p>Thể loại: Giả Tưởng</p>
                    <div class="whitespace-pre-wrap undefined block"><span class="metadata_label__DARMb mr-1 capitalize">
                        <p>Mô tả: 
                            Tai nạn xe khiến cô xuyên không vào thế giới phép thuật. Một giải đấu lại khiến cô trở thành công chúa được hoàng đế nuôi dưỡng. Chỉ là, công chúa nhà người ta đều tận hưởng cuộc sống xúng xính áo gấm lụa là, cao lương mỹ vị no đủ.                      
                        <span id="dots">...</span>
                        <span id="more">
                            Tại sao đến lượt cô lại là những ngày tháng sống trong kho củi cũ rích bẩn thỉu, hết bị đánh rồi bị mắng chửi, còn bị những công chúa khác chà đạp chứ? Không được, cô phải phản công. Nhìn thấy dáng vẻ ấy của cô, hoàng đế mặt lạnh nào đó nhếch khóe môi đầy ý cười: "Đứa phế vật này thú vị thật".
                        </span>
