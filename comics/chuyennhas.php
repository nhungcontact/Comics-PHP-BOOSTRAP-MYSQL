        ...
        <div class="container" style="margin-top: 40px;">
            <div class="row m-3 p-4">
              <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                  ...
                  src="
                  https://vnw-img-cdn.popsww.com/api/v2/containers/file2/cms_thumbnails/cns_thumb_640x960-1fc34f482062-1598949267235-01XvedRG.jpg?v=0&maxW=420&format=webp                 " alt="">
              </div>
              <div class="col-7">
                  <h1 style="color: #fff; margin-top: 10px;">Chuyện Nhà S</h1>
                  <div class="flex py-2 px-2.5 no-underline capitalize desktop:min-w-0 mobile:py-0 mobile:px-4 social_item__0U5H7 comics flex items-center mx-2.5 mobile:flex-col null flex-row">
                    ...
                    <p>Họa sĩ: Vũ Tiến Dũng</p>
                    <p>Thể loại: Hài Hước, Đời Thường</p>
                    <div class="whitespace-pre-wrap undefined block"><span class="metadata_label__DARMb mr-1 capitalize">
                        <p>Mô tả: 
                            Sam là cậu sinh viên nghèo được giới thiệu đến ở trọ trong nhà S - căn nhà chỉ toàn những người có tên bắt đầu với chữ S. Cứ tưởng cuộc sống cứ thế yên ả trôi qua nhưng Sam lại
                            <span id="dots">...</span>
                        <span id="more">
                            phát hiện - căn nhà S này toàn những người điên khùng lập dị. Cuộc sống của Sam trong nhà S trôi qua đầy drama và sự kiện nhưng cũng vô cùng ấm áp.                         </span>
