        ...
        <div class="container" style="margin-top: 40px;">
            <div class="row m-3 p-4">
              <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                  ...
                  src="
                  https://vnw-img-cdn.popsww.com/api/v2/containers/file2/cms_thumbnails/cleanerk_thumb_640x960-280f7f3b048a-1617782888461-pLC01CpF.jpg?v=0&maxW=420&format=webp                   " alt="">
              </div>
              <div class="col-7">
                  <h1 style="color: #fff; margin-top: 10px;">Cleaner K - Kẻ Dọn Dẹp K</h1>
                  <div class="flex py-2 px-2.5 no-underline capitalize desktop:min-w-0 mobile:py-0 mobile:px-4 social_item__0U5H7 comics flex items-center mx-2.5 mobile:flex-col null flex-row">
                        ...
                        <span class="social_infoNumber__8SNKv">12K</span>&nbsp;Lượt xem</span>
                        <i class="fa-solid fa-thumbs-up" style="margin-left: 5px;"></i>
                        <span>3K &nbsp;Thích</span> 
                        </div>
                    </div>
                    <button class="read"> ĐỌC NGAY</button>
                    <p>Tác giả: Shin Jin Woo </p>
                    <p>Họa sĩ: Hong Soon Sik</p>
                    ...
                    <div class="whitespace-pre-wrap undefined block"><span class="metadata_label__DARMb mr-1 capitalize">
                        <p>Mô tả: 
                            ...
                            Con gái của Kim Jin bị người ta bạo hành tập thể dẫn đến mất khả năng làm mẹ, nhưng những kẻ gây tội lại được tại ngoại vì   
                             <span id="dots">...</span>
                        <span id="more">
                            có bố mẹ là quan chức cấp cao, không chỉ vậy, rõ ràng là người bị hại nhưng cô bé lại phải chịu đựng sự chỉ trích của những người xung quanh, cuối cùng tự sát.

                            Kim Jin – nhân viên cục tình báo quốc gia dưới lốt một nhân viên công ty quèn, khi đứng trước di ảnh của con gái, anh ta thề sẽ báo thù cho con.                        </span>
