        ...
        <div class="container" style="margin-top: 40px;">
            <div class="row m-3 p-4">
              <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                  ...
                  src="
                  https://vnw-img-cdn.popsww.com/api/v2/containers/file2/cms_thumbnails/kichroi_thumb_640x960-78aabfabc24d-1629973765010-0UE3o33x.jpg?v=0&maxW=420&format=webp                   " alt="">
              </div>
              <div class="col-7">
                  <h1 style="color: #fff; margin-top: 10px;">Kịch Rối</h1>
                  <div class="flex py-2 px-2.5 no-underline capitalize desktop:min-w-0 mobile:py-0 mobile:px-4 social_item__0U5H7 comics flex items-center mx-2.5 mobile:flex-col null flex-row">
                        ...
                        <span class="social_infoNumber__8SNKv">19K</span>&nbsp;Lượt xem</span>
                        <i class="fa-solid fa-thumbs-up" style="margin-left: 5px;"></i>
                        <span>1K &nbsp;Thích</span> 
                        </div>
                    </div>
                    <button class="read"> ĐỌC NGAY</button>
                    <p>Tác giả: Tum Ulit</p>
                    <p>Họa sĩ: Tum Ulit</p>
                    ...
                    <div class="whitespace-pre-wrap undefined block"><span class="metadata_label__DARMb mr-1 capitalize">
                        <p>Mô tả: 
                            "Chào mừng quý vị đến Rạp hát Kịch Rối dì Soi. Khi xem, quý vị có thể thấy tình huống hơi thiếu thực tế. Thế nhưng nên nhớ rằng cuộc sống thật của chúng ta còn                         <span id="dots">...</span>
                        <span id="more">
                            drama hơn nhiều!". Kịch Rối - tác phẩm truyện tranh mang phong cách lạ và dị của họa sĩ sáng tạo nổi tiếng Tum Ulit của Thái Lan, độc quyền trên POPS.
                        </span>
