        ...
        <div class="container" style="margin-top: 40px;">
            <div class="row m-3 p-4">
              <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                  ...
                  src="https://vnw-img-cdn.popsww.com/api/v2/containers/file2/cms_thumbnails/new_verticle_thumb_640x960-15f3b155b380-1640256073132-KwEwwZwL.jpg?v=0&maxW=420&format=webp" alt="">
              </div>
              <div class="col-7">
                  <h1 style="color: #fff; margin-top: 10px;">Kiếp Văn Phòng</h1>
                  <div class="flex py-2 px-2.5 no-underline capitalize desktop:min-w-0 mobile:py-0 mobile:px-4 social_item__0U5H7 comics flex items-center mx-2.5 mobile:flex-col null flex-row">
                        ...
                        <span class="social_infoNumber__8SNKv">1M</span>&nbsp;Lượt xem</span>
                        <i class="fa-solid fa-thumbs-up" style="margin-left: 5px;"></i>
                        <span>133K &nbsp;Thích</span> 
                        </div>
                    </div>
                    <button class="read"> ĐỌC NGAY</button>
                    <p>Tác giả: Nguyễn Huỳnh Bảo Châu</p>
                    <p>Họa sĩ: Nguyễn Thị Hiếu Hạnh</p>
                    <p>Thể loại: Comedy serries, Hài Hước, Đời Thư</p>
                    <div class="whitespace-pre-wrap undefined block"><span class="metadata_label__DARMb mr-1 capitalize">
                        <p>Mô tả: Một công ty tưởng bình thường nhưng vô cùng bất thường, với nhân viên là những người đi làm vì đam mê chứ nhà là tỷ phú, là con ông cháu cha được nhận vì
                        <span id="dots">...</span>
                        <span id="more">những kẻ thủ ác tại hiện trường và cũng vì thế mà chịu án tù 10 năm.
                            tài năng gây war, là một gián điệp kinh tế  nhưng lại hay giúp kẻ địch phát tài.....Hãy đến với Kiếp Văn Phòng và 7749 tình huống xử lý đi vào lòng đất khi đối diện với khách hàng. </span>
                            </p>
