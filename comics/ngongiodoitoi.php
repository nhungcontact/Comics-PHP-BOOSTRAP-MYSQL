        ...
        <div class="container" style="margin-top: 40px;">
            <div class="row m-3 p-4">
              <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                  ...
                  src="
                  https://vnw-img-cdn.popsww.com/api/v2/containers/file2/cms_thumbnails/640x960-807594ff1a53-1590052730072-bWRfojp4.jpg?v=0&maxW=420&format=webp                   " alt="">
              </div>
              <div class="col-7">
                  <h1 style="color: #fff; margin-top: 10px;">Ngọn Gió Đời Tôi</h1>
                  <div class="flex py-2 px-2.5 no-underline capitalize desktop:min-w-0 mobile:py-0 mobile:px-4 social_item__0U5H7 comics flex items-center mx-2.5 mobile:flex-col null flex-row">
                        ...
                        <span class="social_infoNumber__8SNKv">30K</span>&nbsp;Lượt xem</span>
                        <i class="fa-solid fa-thumbs-up" style="margin-left: 5px;"></i>
                        <span>2K &nbsp;Thích</span> 
                        </div>
                    </div>
                    <button class="read"> ĐỌC NGAY</button>
                    <p>Tác giả: Phong Lee</p>
                    <p>Họa sĩ: Phong Lee</p>
                    <p>Thể loại: Đời Thường</p>
                    <div class="whitespace-pre-wrap undefined block"><span class="metadata_label__DARMb mr-1 capitalize">
                        <p>Mô tả: 
                            Đông triều, chàng trai không bình thường nhưng tràn đầy tham vọng, sau khi có giấy nhập ngũ cậu bắt đầu cuộc sống mới trong quân đội, tại đây cậu bất ngờ khi biết rằng Trường Giang người bạn thân duy nhất cũng đang ở cùng Tiểu đội với mình. Trải qua biết bao nhiêu                         <span id="dots">...</span>
                        <span id="more">
                            hỉ, nộ, ái, ố Đông triều đem lòng yêu mến Trường Giang nhưng luôn bị cậu bạn từ chối, lúc nào Giang cũng tỏ ra vẻ gắt gỏng với mọi người xung quanh nhưng thực chất đâu ai hiểu rằng chính cậu cũng đang bị tổn thương về mặt cảm xúc, cậu quyết định đóng cửa trái tim mình.
                        </span>
