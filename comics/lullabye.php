        ...
        <div class="container" style="margin-top: 40px;">
            <div class="row m-3 p-4">
              <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                  ...
                  src="
                  https://vnw-img-cdn.popsww.com/api/v2/containers/file2/cms_thumbnails/lullabye_thumb_640x960-de5d6ecbc6af-1631264408902-2vEnRSdp.jpeg?v=0&maxW=420&format=webp   " alt="">
              </div>
              <div class="col-7">
                  <h1 style="color: #fff; margin-top: 10px;">Lullabye - Giai Điệu Cuối</h1>
                  <div class="flex py-2 px-2.5 no-underline capitalize desktop:min-w-0 mobile:py-0 mobile:px-4 social_item__0U5H7 comics flex items-center mx-2.5 mobile:flex-col null flex-row">
                        ...
                        <span class="social_infoNumber__8SNKv">100K</span>&nbsp;Lượt xem</span>
                        <i class="fa-solid fa-thumbs-up" style="margin-left: 5px;"></i>
                        <span>30K &nbsp;Thích</span> 
                        </div>
                    </div>
                    <button class="read"> ĐỌC NGAY</button>
                    <p>Tác giả: Chellin</p>
                    <p>Họa sĩ: Chellin</p>
                    ...
                    <div class="whitespace-pre-wrap undefined block"><span class="metadata_label__DARMb mr-1 capitalize">
                        <p>Mô tả: 
                            Chàng trai đau đớn trước cái chết của người yêu, bèn tự vẫn theo. Nhưng người đã khuất bất ngờ xuất hiện ngăn cản cái chết của anh ta, kèm một lời                        <span id="dots">...</span>
                        <span id="more">
                            hăm dọa "Anh nghĩ rằng mình sẽ chết dễ dàng như vậy sao? Sau tất cả những gì anh đã làm với tôi?". Vậy chân tướng câu chuyện rốt cuộc là gì?  
                        </span>
