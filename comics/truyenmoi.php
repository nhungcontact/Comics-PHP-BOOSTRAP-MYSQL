...
<body>
            ...
            <div class="left_header">
                ...
                <nav>
                    <ul class="main_menu">
                        ...
                        <li><a href="truyenmoi.php" class="items_menu active_nav">
                        New & Tredding
                        </a></li>
                    </ul>
                </nav>
 ...
 <main class="container">
       ...
       <!-- truyen moi -->
       <div class="mt-4">
            <h1 class="topic truyenmoi">Truyện Mới & Nổi Bật</h1>
           <div>
               ...
               <div class="owl-carousel owl-theme new">
                   <a href="tuyetdinh.php" class="img_new"> 
                       ...
                       <h6 title="Tuyệt Đỉnh">Tuyệt Đỉnh</h6>
                       <p>Hành Động (Nổi Bật)</p>
                   </a>
                   <a href="lullabye.php" class="img_new">
                       ...
                       <h6 title="Lullabye - Giai Điệu Cuối">Lullabye - Giai Điệu Cuối</h6>
                       <p>Kinh Dị (Nổi Bật)</p>
                   </a>
                   <a href="septoilacho.php" class="img_new"> 
                       ...
                       <h6 title="Sếp Tôi Là Chó">Sếp Tôi Là Chó</h6>
                       <p>Hài Hước (Nổi Bật)</p>
                   </a>
                   <a href="nhungmua.php" class="img_new"> 
                       ...
                       <h6 title="Những mùa">Những mùa</h6>
                       <p>Đời Thường (Nổi Bật)</p>
                   </a>

               </div> 
               <div class="owl-carousel owl-theme new">
                   <a href="kiepvanphong.php" class="img_new"> 
                   ...
                   <h6 title="Kiếp Văn Phòng">Kiếp Văn Phòng</h6>
                       <p>Hài Hước (Nổi Bật)</p>
                   </a>
                   <a href="chuyennhas.php" class="img_new">
                   <img alt="Chuyện nhà S" title="Chuyện nhà S" src="https://vnw-img-cdn.popsww.com/api/v2/containers/file2/cms_thumbnails/cns_thumb_640x960-1fc34f482062-1598949267235-01XvedRG.jpg?v=0&amp;maxW=420&amp;format=jpg">
                       <h6 title="Chuyện nhà S">Chuyện Nhà S</h6>
                       <p>Đời Thường (Nổi Bật)</p>
                   </a>
                   <a href="kieunudocphi.php" class="img_new"> 
                   ...
                   <h6 title="Kiều Nữ Độc Phi ">Kiều Nữ Độc Phi</h6>
                       <p>Lãng Mạn Cổ Trang (Nổi Bật)</p>
                   </a>
                   <a href="sharkcamap.php" class="img_new"> 
                   <img alt="Shark - Cá Mập" title="Shark - Cá Mập" src="https://vnw-img-cdn.popsww.com/api/v2/containers/file2/cms_thumbnails/shark_thumb_640x960-0a4f74557138-1616473865665-u7RV4a8u.jpg?v=0&amp;maxW=260&amp;format=jpg">
                       <h6 title="Shark - Cá Mập">Shark - Cá Mập</h6>
                       <p>Hành Động (Nổi Bật)</p>
                   </a>
