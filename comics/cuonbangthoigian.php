        ...
        <div class="container" style="margin-top: 40px;">
            <div class="row m-3 p-4">
              <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                  ...
                  src="
                  https://vnw-img-cdn.popsww.com/api/v2/containers/file2/cms_thumbnails/cbtg_thumb_640x960-74575dd50f47-1593759782471-QUSToAAY.jpg?v=0&maxW=420&format=webp  " alt="">
              </div>
              <div class="col-7">
                  <h1 style="color: #fff; margin-top: 10px;">Cuộn Băng Thời Gian</h1>
                  <div class="flex py-2 px-2.5 no-underline capitalize desktop:min-w-0 mobile:py-0 mobile:px-4 social_item__0U5H7 comics flex items-center mx-2.5 mobile:flex-col null flex-row">
                        ...
                        <span class="social_infoNumber__8SNKv">10K</span>&nbsp;Lượt xem</span>
                        <i class="fa-solid fa-thumbs-up" style="margin-left: 5px;"></i>
                        <span>3K &nbsp;Thích</span> 
                        </div>
                    </div>
                    <button class="read"> ĐỌC NGAY</button>
                    <p>Tác giả: Lee Eun Sea</p>
                    <p>Họa sĩ: Do Do</p>
                    <p>Thể loại: Đời Thường, Giả Tưởng, Tình Cảm</p>
                    <div class="whitespace-pre-wrap undefined block"><span class="metadata_label__DARMb mr-1 capitalize">
                        <p>Mô tả: 
                            Ban Hana là một nữ thần tượng 9x nổi tiếng, một ngày trên đường về nhà cô được một fan lạ mặt gửi tặng một chiếc walkman cũ kỹ. Cô không ngờ rằng chiếc                        <span id="dots">...</span>
                        <span id="more">
                            walkman đó sau này lại đưa cô quay về quá khứ năm 1987, để rồi cô được gặp mặt thần tượng của chính cô, người được mệnh danh là nhạc sĩ thiên tài của một thế hệ....
                        </span>
