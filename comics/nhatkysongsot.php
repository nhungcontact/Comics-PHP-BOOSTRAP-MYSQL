        ...
        <div class="container" style="margin-top: 40px;">
            <div class="row m-3 p-4">
              <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                  ...
                  src="
                  https://vnw-img-cdn.popsww.com/api/v2/containers/file2/cms_thumbnails/nuphu_thumb_640x960-b49f611cd199-1634696296441-g3GPK9dp.jpg?v=0&maxW=420&format=webp                   " alt="">
              </div>
              <div class="col-7">
                  <h1 style="color: #fff; margin-top: 10px;">Nhật Kí Sống Sót Của Nữ Phụ Phản Diện</h1>
                  <div class="flex py-2 px-2.5 no-underline capitalize desktop:min-w-0 mobile:py-0 mobile:px-4 social_item__0U5H7 comics flex items-center mx-2.5 mobile:flex-col null flex-row">
                        ...
                        <span>156K &nbsp;Thích</span> 
                        </div>
                    </div>
                    <button class="read"> ĐỌC NGAY</button>
                    <p>Tác giả: Vân MC, Lại Hoàng Lê</p>
                    <p>Họa sĩ: Vân MC, Lại Hoàng Lê</p>
                    <p>Thể loại: Tình Cảm</p>
                    <div class="whitespace-pre-wrap undefined block"><span class="metadata_label__DARMb mr-1 capitalize">
                        <p>Mô tả: 
                            guyệt, một diễn viên chuyên vai phản diện trong các bộ phim ngôn tình, nay xuyên không vào chính kịch bản phim mà mình vừa đóng, theo kịch bản thì cô ấy sẽ bị nam chính thiêu cháy vào năm 20 tuổi. Không muốn chết một cách sáng chói như thế, Nguyệt quyết định                        <span id="dots">...</span>
                        <span id="more">
                            phải lấy lòng nam chính để nam chính không có lý do gì giết mình. Tuy nhiên, một người thay đổi khiến toàn bộ câu chuyện thay đổi, nam chính lại quay ra yêu nữ phụ phản diện. Nguyệt càng cố gắng đẩy câu chuyện đi vào quỹ đạo ban đầu thì nó càng trôi ra xa.
                        </span>
